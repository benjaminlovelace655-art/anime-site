...
export const metadata = { title: 'About — AniLove' };
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20 pt-28">
      ...
      <div className="space-y-4 text-sm text-[var(--text-secondary)] leading-relaxed">
        <p>AniLove is a free anime discovery and streaming platform built for fans by a fan. We aggregate anime metadata from MyAnimeList via the Jikan API and provide direct links to streaming sources.</p>
        ...
        <p>AniLove does not host any video content. All video streams are provided by third-party services. This site is for testing and educational purposes only. We are not affiliated with any anime studio or distributor.</p>
