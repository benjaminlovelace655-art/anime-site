    ...
    >
      ...
      <div className="relative z-10 flex w-full items-center justify-between py-3 pr-4 pl-6">
        ...
        {status === 'authenticated' && session?.user ? (
          <Link
            href="/profile"
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-[var(--accent)] transition-all"
          >
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-emerald-600 to-green-500 flex items-center justify-center text-xs font-bold text-black">
          ...
          <div className="w-20 h-9 rounded-xl bg-[var(--bg-card)] shimmer" />
        ) : (
          <Link
            href="/login"
