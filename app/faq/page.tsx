...
export const metadata = { title: 'FAQ — AniByte' };
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20 pt-28">
      ...
      <div className="space-y-6 text-sm text-[var(--text-secondary)] leading-relaxed">
        {[
          { q: 'Is AniByte free?', a: 'Yes, AniByte is completely free to use. No registration or payment required.' },
          { q: 'Do you host any videos on your servers?', a: 'No. AniByte does not host, store, or upload any video content. We only provide links to third-party streaming services.' },
          ...
          { q: 'What is AniTanks?', a: 'AniTanks is a browser-based tank battle game built as a companion to AniByte. Fight AI bots, collect power-ups, and climb the leaderboard.' },
          ...
          { q: 'Is there a mobile app?', a: 'Not yet. AniByte is a web app optimized for both desktop and mobile browsers.' },
        ].map((faq, i) => (
