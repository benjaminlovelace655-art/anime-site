...
export const metadata = { title: 'Terms of Service — AniLove' };
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20 pt-28">
      ...
      <div className="space-y-4 text-sm text-[var(--text-secondary)] leading-relaxed">
        <p>By using AniLove, you agree to the following terms and conditions. If you do not agree, please do not use this service.</p>
        <h2 className="text-lg font-bold text-white pt-4">Use of Service</h2>
        <p>AniLove is provided for testing and educational purposes only. You may use the site to discover and browse anime information. The site does not host any video content.</p>
        <h2 className="text-lg font-bold text-white pt-4">Intellectual Property</h2>
        <p>All anime data, images, and metadata are property of their respective owners (MyAnimeList, anime studios, and distributors). AniLove claims no ownership over any content displayed.</p>
        ...
        <p>AniLove is provided &ldquo;as is&rdquo; without any warranty. We are not liable for any damages arising from the use of this site.</p>
